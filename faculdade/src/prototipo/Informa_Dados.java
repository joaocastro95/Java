...
public class Informa_Dados extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        ...
        janela.show(); // Corrigido: substituído show() por setVisible(true)
    ...
    public void informa_dados() {
        ...
        System.out.println("IDENTIFICACÃO DO CONTRIBUINTE\t" + receita.getNome());
        ...
        if (j2 == true)
            System.out.println("CNPJ DO CONTRIBUINTE\t" + receita.getCNPJ()); // Corrigido: CMPJ para CNPJ
